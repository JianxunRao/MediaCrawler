...
async def parse_cmd():
    ...
    parser.add_argument('--platform', type=str, help='Media platform select (xhs | dy | ks | bili | wb | tieba | zhihu | toutiao)',
                        choices=["xhs", "dy", "ks", "bili", "wb", "tieba", "zhihu", "toutiao"], default=config.PLATFORM)
